...
// console.log("Challenge 1 \n", inventory[i].car_year, inventory[i].car_make, inventory[i].car_model);
//   }
// }
...
// let carModels = inventor.map(car = car.car_model).sort();
...
// function year (array){
//   for (let i = 0; i < inventory.length; i++) {
//     corYears.push(inventory[i].car_year);
//     }
//   };
//   console.log("Challenge 4 \n", year(inventory));
